  ...
  return (
    <main className="grid h-[51vh] lg:h-[67.2vh] place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div className="text-center">
        ...
        <p className="mt-6 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">Sorry, The page you are looking for doesn&apos;t exist or it was silenced by the CIA</p>
